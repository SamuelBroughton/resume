...
\moveleft.5\hoffset\centerline{\
  ...
  \href{https://github.com/SamuelBroughton}{github.com/SamuelBroughton\qquad}
  \includegraphics[scale=0.025, trim = 0mm 25mm 0mm 0mm]{email19.pdf}
  \href{mailto:sbrought@pm.me}{sbrought@pm.me\qquad}
...
\begin{thebibliography}{1}
	...
	\bibitem{latexGuide} Broughton, S.J., Jalal, M.A., Moore, R.K. (2021) Investigating Deep Neural Structures and their Interpretability in the Domain of Voice Conversion. Proc. Interspeech 2021, 806-810, \textit{doi: 10.21437/Interspeech.2021-1730}.
...
%Prof. Roger Moore \textit{(Dissertation Supervisor)}\\
